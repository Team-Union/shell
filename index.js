...
client.on('message', message => {
    ...
    let out = '';
    if (message.content.includes('pm2') || message.content.includes('node') || message.content.includes('yarn start') || message.content.includes('npm start') || message.content.includes('yarn run start')) return;
